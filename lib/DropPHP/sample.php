...
function dropbox_compare_file_dates($a, $b)
{
    $a_ts = strtotime($a->modified);
    $b_ts = strtotime($b->motified);
...
usort($files, 'dropbox_compare_file_dates');
...
/*$bobfilepath = "README.md";
echo "\r\n\r\n<b>Uploading $bobfilepath:</b>\r\n";
	print_r($dropbox->UploadFile($bobfilepath));
echo "\r\n done!"; */
